...
const char *MACROS[] = {
  ...
  "i_like_the_diff",
  "hollup_ship_it",
  "my_job_is_just_accept",
  "its_one_stamp_michael",
  "your_stamp_maam",
  "eyes_closed_stamp",
  "accept_diff_card",
  "spongebob_stamp2unblock",
  "gods_testplan",
  "royalmailstamp",
  "let_him_cook",
  "quality_thumbs_up",
  "slays_expectations",
  "you_have_my_stamp",
  "test_in_prod_not_animals",
  "slowaccept",
  "colonel_toad_stamp",
  "horn_of_acceptance_cat",
  "ship_it_tube",
  "american_psycho_stamp",
  "lousy_tshirt_stamp",
  "lgtm_novi",
  "ill_stamp_to_that_bro",
  "baddiffghost",
  "fastest_stamp_in_the_west",
  "warm_up_diff_review",
  "yeah_i_stamp",
  "ship_happens",
  "good_to_ship",
  "lgtm_bouncer",
  "change_straight_to_sev",
  "wcgw_cat",
  "guccidiffghost",
  "lgtm_im_baby",
  "citrus_stamp",
